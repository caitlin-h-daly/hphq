...
#' were discarded as burn-in, and the subsequent 100,000 samples were thinned by
#' 200, resulting in a total of 1,500 samples saved in this data frame. The
#' outcome is American College of Rheumatology 50\% improvement (ACR50) response
#' rate at 6 months.
#'
#' @format A data frame with 1,500 rows and 6 columns:
#' \describe{
