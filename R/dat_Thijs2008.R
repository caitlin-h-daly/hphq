#' Antiplatelet regimens for the prevention of serious vascular events after
#' transient ischaemic attack (TIA) or stroke
#'
#' Samples from the joint distribution of the relative effects for each
#' active treatment (aspirin, aspirin + dipyridamole, thienopyridines,
...
#' subsequent 5,000 samples were thinned by 10, resulting in a total of 1,500
#' samples saved in this data frame. The outcome is serious vascular events.
#'
...
#' }
#'
#' @source Thijs V, Lemmens R, Fieuws S. (2008). Network meta-analysis: simultaneous meta-analysis of common antiplatelet regimens after transient ischaemic attack or stroke, Eur Heart J 29(9):1086-92. [doi:10.1093/eurheartj/ehn106]. Adopted from nmadb::readByID(501404)$data.
#'
#' data(dat_Thijs2008)
"dat_Thijs2008"
